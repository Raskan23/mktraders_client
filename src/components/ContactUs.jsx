                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                    ...
                    <div className="bg-white rounded-lg p-8 shadow-md md:col-span-2">
                        ...
                        <div className="mb-4 flex items-center">
                            ...
                            <div>
                                <p className="text-gray-700">+94 76 24 25 678</p>
                        ...
                        <div className="mb-4 flex items-center">
                            ...
                            <div>
                                <p className="text-gray-700">rasproject@gmail.com</p>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href={`https://wa.me/${+94762425678}?text=Hello!%20This%20is%20a%20dummy%20message.`} className="text-green-400 hover:text-green-600" target="_blank"
